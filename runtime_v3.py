...
def signature(a):
    ...
    paths={'resume','model_path','source_path','point_cloud','train_file','val_file','cameras_file','test_file','baseline_result','lidar_depth_cache','lidar_depth_export','data_manifest','supervision_root','precomputed_root','supervision_manifest'}
