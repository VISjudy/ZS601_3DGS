...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def backward(ctx, grad_out_color, _, grad_out_depth, grad_out_normal):
        ...
        # 阶段2新功能：法向图梯度已并入 grad_rotations（法向只依赖四元数），
        # grad_normals 为每高斯法向中间量，不直接对应输入参数
        grad_means2D, grad_colors_precomp, grad_opacities, grad_means3D, grad_cov3Ds_precomp, grad_sh, grad_scales, grad_rotations, grad_normals = _C.rasterize_gaussians_backward(*args)        
