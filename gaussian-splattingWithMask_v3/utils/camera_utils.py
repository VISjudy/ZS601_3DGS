...
def loadCam(args, id, cam_info, resolution_scale, is_nerf_synthetic, is_test_dataset):
    # 新功能：懒加载模式（args.lazy_load）——不在这里解码全部图片，只读图片头获取尺寸，
    # 真正的解码推迟到训练访问该相机时，配合 LRU 缓存防止爆 RAM
    ...
    return Camera(resolution, colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T, 
                  ...
                  lazy=lazy, image_path=cam_info.image_path, mask_path=cam_info.mask_path if lazy else "")
